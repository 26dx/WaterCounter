 ...
 * This can be useful if you want to give the end user an overview of the value
 * limits.
 *
...
public:
  ...
  virtual void
  render_custom_numeric_menu_item(CustomNumericMenuItem const &menu_item) const;
